...
"background-color: rgb(255, 255, 255);")
        ...
        sizePolicy.setHeightForWidth(self.folder_path_pt.sizePolicy().hasHeightForWidth())
        self.folder_path_pt.setSizePolicy(sizePolicy)
        font2 = QFont()
        font2.setFamilies([u"Roboto Slab SemiBold"])
        font2.setPointSize(14)
        font2.setBold(True)
        self.folder_path_pt.setFont(font2)
        self.folder_path_pt.setAutoFillBackground(False)
        self.folder_path_pt.setStyleSheet(u"background-color: rgb(53, 65, 83);")
        icon = QIcon()
        icon.addFile(u":/icons/icons/folder-image-line.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.folder_path_pt.setIcon(icon)
        self.folder_path_pt.setIconSize(QSize(20, 20))
        ...
        sizePolicy.setHeightForWidth(self.caption_dest_pt.sizePolicy().hasHeightForWidth())
        self.caption_dest_pt.setSizePolicy(sizePolicy)
        self.caption_dest_pt.setFont(font2)
        self.caption_dest_pt.setStyleSheet(u"background-color: rgb(53, 65, 83);")
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/file-text-outlined_1.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.caption_dest_pt.setIcon(icon1)
        self.caption_dest_pt.setIconSize(QSize(20, 20))
        ...
        self.run_cation_pt.setGeometry(QRect(500, 175, 200, 40))
        font3 = QFont()
...
"")
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/image-search_3.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.run_cation_pt.setIcon(icon2)
        self.run_cation_pt.setIconSize(QSize(24, 24))
        self.label_5 = QLabel(self.frame)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(900, 200, 131, 30))
        ...
        self.label_server_status.setGeometry(QRect(1040, 200, 131, 30))
...
"color: rgb(255, 0, 0);")
        ...
        self.info_pt.setGeometry(QRect(20, 10, 71, 30))
        font5 = QFont()
        font5.setFamilies([u"Roboto"])
        font5.setPointSize(10)
        font5.setBold(True)
        self.info_pt.setFont(font5)
        self.info_pt.setStyleSheet(u"background-color: rgb(63, 65, 83);")
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/file-info-fill (1).svg", QSize(), QIcon.Normal, QIcon.Off)
        self.info_pt.setIcon(icon3)
        self.info_pt.setIconSize(QSize(20, 20))
        self.info_pt.setFlat(False)
...
"color: rgb(0, 85, 107);")
        ...
        self.spinBox_checkserver_time = QSpinBox(self.frame)
        self.spinBox_checkserver_time.setObjectName(u"spinBox_checkserver_time")
        self.spinBox_checkserver_time.setGeometry(QRect(1110, 160, 60, 30))
        font7 = QFont()
        font7.setFamilies([u"Roboto Slab SemiBold"])
        font7.setPointSize(12)
        font7.setWeight(QFont.DemiBold)
        font7.setItalic(False)
        self.spinBox_checkserver_time.setFont(font7)
        self.spinBox_checkserver_time.setStyleSheet(u"font: 600 12pt \"Roboto Slab SemiBold\";")
        self.spinBox_checkserver_time.setAlignment(Qt.AlignCenter)
        self.spinBox_checkserver_time.setValue(30)
        self.label_4 = QLabel(self.frame)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(900, 160, 180, 30))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Check server Time:", None))
    # retranslateUi
